...
#1b: Update target
cd "$1/sUTLHaxePython" || { echo '010' ; exit 1; }
git checkout master
...
python "$1/fixpy.py" < "$1/sUTLHaxePython/sUTLTestsPre.py" > "$1/sUTLHaxePython/sUTLTests.py" || { echo '035' ; exit 1; }
python "$1/sUTLHaxePython/sUTLTests.py" || { echo '040' ; exit 1; }
